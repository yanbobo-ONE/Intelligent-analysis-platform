...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--prompt-file", default=None, help="Read prompt from a text file (UTF-8)")
...
def main() -> int:
    ...
    if args.prompt_file:
        try:
            ...
            print("\nError: failed to read prompt file.", file=sys.stderr)
            print(f"path: {args.prompt_file}", file=sys.stderr)
